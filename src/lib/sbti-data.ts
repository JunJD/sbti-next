...
export type DimensionId = keyof typeof dimensionMeta;
export type DimensionLevel = 'L' | 'M' | 'H';
export type QuestionOption = { label: string; value: number };
export type RegularQuestion = (typeof questions)[number];
export type SpecialQuestion = (typeof specialQuestions)[number];
export type Question = RegularQuestion | SpecialQuestion;
export type TypeCode = keyof typeof typeLibrary;
export type NormalTypePattern = (typeof normalTypes)[number];
export type TypeProfile = (typeof typeLibrary)[TypeCode];
export type AnswerMap = Partial<Record<RegularQuestion['id'] | SpecialQuestion['id'], number>>;
